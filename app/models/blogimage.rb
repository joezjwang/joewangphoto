class Blogimage < ActiveRecord::Base
	belongs_to :post
	has_attached_file :image, :styles => {:original => "1600x1600>",  :pc_large => "x720", :pc_small => "x480", :mobile_large => "480x"}, :convert_options => { :pc_large => '-quality 80 -interlace Plane', :pc_small => '-quality 82 -interlace Plane', :mobile_large => '-quality 80 -interlace Plane'},  :default_url => "/missing.png"
