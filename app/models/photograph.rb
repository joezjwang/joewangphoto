class Photograph < ActiveRecord::Base
  ...
  has_attached_file :photo, :styles => {:original => "1600x1600>", :thumb => "320x320>#", :pc_large => "x720", :pc_small => "x480", :mobile_large => "480x"}, :convert_options => { :thumb => '-quality 75 -interlace Plane', :pc_large => '-quality 80 -interlace Plane', :pc_small => '-quality 80 -interlace Plane', :mobile_large => '-quality 80 -interlace Plane'},  :default_url => "/missing.png"
