class Product < ActiveRecord::Base
	...
	has_attached_file :product_photo, :styles => {:original => "1600x1600>",  :pc => "x400", :mobile => "450x"}, :convert_options => { :pc => '-quality 80 -interlace Plane', :mobile => '-quality 75 -interlace Plane'},  :default_url => "/missing.png"
